...
$(document).ready(function(){
  $('.sub-mn').hide();
  $('.sub-sl').hide();
  $(".has-sub-m").append("<span class='drop_down_icon fa fa-angle-down'></span>");
  $(".has-sub-s").append("<span class='drop_down_iconsm fa fa-angle-down'></span>");

  $(".has-sub-m .drop_down_icon").click(function(){   
    $(this).closest('.has-sub-m').find(".sub-mn").slideToggle();
    $(this).closest('.has-sub-m').toggleClass("arw_up");  
  });
  $(".has-sub-s .drop_down_iconsm").click(function(){  
    $(this).closest('.has-sub-s').find(".sub-sl").slideToggle();
    $(this).closest('.has-sub-s').toggleClass("arw_upsm");
  });
...
if ($(window).width() < 901) {
  $(".mega_menu").append("<span class='drop_down_icon fa fa-angle-down'></span>");
  $('.mega_menu .drop_down_icon').click(function(){	 	
     $(this).closest('.mega_menu').find(".menu-drop").slideToggle();
     $(this).toggleClass("c_arw_up");	 	
  });
