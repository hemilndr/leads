            ...
            <form action="{{route('admin.group.update')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="tezt" name="title" class="form-control" id="title" value="{{ old('title', isset($group) ? $group->title : '') }}" placeholder="Enter Title">
                  {!! $errors->first('title', '<p style="color:red;" class="help-block error">:message</p>') !!}
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Description</label>
                  <input type="tezt" name="description" class="form-control" id="description" value="{{ old('description', isset($group) ? $group->description : '') }}" placeholder="Enter Desc">
