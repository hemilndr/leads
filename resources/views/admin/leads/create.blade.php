            ...
            <form action="{{route('admin.user.save')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="tezt" name="name" class="form-control" id="name" value="{{ old('name') }}" placeholder="Enter Name">
                  {!! $errors->first('name', '<p style="color:red;" class="help-block error">:message</p>') !!}
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Email</label>
                  <input type="tezt" name="email" class="form-control" id="email" value="{{ old('email') }}" placeholder="Enter Email">
                  {!! $errors->first('email', '<p style="color:red;" class="help-block error">:message</p>') !!}
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Mobile</label>
                  <input type="tezt" name="mobile" class="form-control" id="mobile" value="{{ old('mobile') }}" placeholder="Enter Mobile">
